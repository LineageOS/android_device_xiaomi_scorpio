...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="scorpio-user 7.0 NRD90M V9.5.4.0.NADMIFA release-keys"

# Set BUILD_FINGERPRINT variable to be picked up by both system and vendor build.prop
BUILD_FINGERPRINT := "Xiaomi/scorpio/scorpio:7.0/NRD90M/V9.5.4.0.NADMIFA:user/release-keys"
