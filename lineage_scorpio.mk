...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="scorpio-user 8.0.0 OPR1.170623.032 V9.6.1.0.OADMIFD release-keys" \
    BuildFingerprint=Xiaomi/scorpio/scorpio:8.0.0/OPR1.170623.032/V9.6.1.0.OADMIFD:user/release-keys
